...
export function HomeScreen({ state, retry, onOpen, onPlay, onToggleList, saved, canSave }) {
  ...
  return <ScrollView style={s.page} contentContainerStyle={s.content}>
    ...
    {state?.loading
      ...
      : state?.error
        ...
        : showEditorial
          ? <View style={s.notice}><Text style={s.noticeTitle}>The Ripple catalogue is coming soon</Text><Text style={s.noticeText}>The live catalogue has no published titles yet. Explore non-playable Ripple editorial concepts below.</Text></View>
          : null}
